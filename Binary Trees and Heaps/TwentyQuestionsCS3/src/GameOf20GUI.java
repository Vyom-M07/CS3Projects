...
public class GameOf20GUI extends JFrame {
	...
	private void setUpModel() throws FileNotFoundException {
		...
		IOarea.setEditable(false); // Added by Vyom
		IOarea.setText(theGame.getCurrent() + "\n");
		gameTreeArea.setFont(new Font("Serif", Font.BOLD, 18)); // Added by Vyom
		gameTreeArea.setEditable(false); // Added by Vyom
	...
	private void runSaveGameDialog() throws IOException {
		if (couldBeSaved) {
			int option = JOptionPane.showConfirmDialog(null,
